			...
			if (userDoc.exists() && problemDoc.exists()) {
				if (liked) {
					...
					setCurrentProblem((prev) =>
						prev ? { ...prev, likes: prev.likes + 1, disliked: prev.disliked - 1 } : null
					);
		...
		await runTransaction(firestore, async (transaction) => {
			...
			if (userDoc.exists() && problemDoc.exists()) {
				...
				if (disliked) {
					...
					setCurrentProblem((prev) => (prev ? { ...prev, disliked: prev.disliked - 1 } : null));
					...
					setCurrentProblem((prev) =>
						prev ? { ...prev, disliked: prev.disliked + 1, likes: prev.likes - 1 } : null
					);
						...
						{!loading && currentProblem && (
							<div className='flex items-center mt-3'>
								...
								>
									...
									<span className='text-xs'>{currentProblem.disliked}</span>
								</div>
								<div
